(function() {
        ...
        angular.module("app.ui.ctrls", []).controller("NotifyCtrl", ["$scope", "logger", function($scope, logger) {
            return $scope.notify = function(type) {
                switch (type) {
                    ...
                    case "warning":
                        return logger.logWarning("Warning! Please Check your Action Again");
                    case "error":
    ...
    function() {
        ...
        angular.module("app", ["ngRoute", "ngAnimate", "ui.bootstrap", "easypiechart", "mgo-angular-wizard", "textAngular", "ui.tree", "ngMap", "ngTagsInput", "app.ui.ctrls", "app.ui.directives", "app.ui.services", "app.controllers", "app.directives", "app.form.validation", "app.ui.form.ctrls", "app.ui.form.directives", "app.tables", "app.map", "app.task", "app.localization", "app.chart.ctrls", "app.chart.directives", "app.page.ctrls"]).config(["$routeProvider", function($routeProvider) {
            return $routeProvider.when("/", {
            ...
            }).when("/dashboard", {						//  calling up the dashboard page with name dashboard
                templateUrl: "views/dashboard.html"
            }).when("/menu/generate", {					//  generate menu
                templateUrl: "views/menu/new/generate.html"
            }).when("/Schedule", {					//  generate menu
                templateUrl: "views/menu/new/Schedule.html"
            }).when("/menu/update", {					//  update_menu
                templateUrl: "views/menu/new/update_menu.html"
            }).when("/menu/delete", {					//  delete_menu
                templateUrl: "views/menu/new/delete_menu.html"
            }).when("/menu/role_delete", {					//  delete_role
                templateUrl: "views/menu/new/delete_role.html"
            }).when("/menu/user_lock", {					//  user_lock
                templateUrl: "views/menu/new/user_lock.html"
            }).when("/menu/admin_profile", {					//  admin profile
                templateUrl: "views/menu/new/admin_profile.html"
            }).when("/menu/customize", {					//  admin customize
                templateUrl: "views/menu/new/customize.html"
            }).when("/ui/typography", {
                ...
                templateUrl: "views/forms/roll.html"
            }).when("/forms/update", {
    ...
    function() {
		...
		.controller("patient_request",["$scope", function($scope){
